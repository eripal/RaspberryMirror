            ...
            function WhatWeather(settings){
                ...
                var options = {
                    ...
                    templates: ['<div class="{{cssClass}}">\
                         <div class="current">\
                            <p>\
                             <span class="temperature">{{currentCondition.temp}}°</span>\
                         ...
                         <div class="next-days" style="display:none">\
                            ...
                            <p>\
                             ...
                             <span class="temp-max">{{maxtempC}}°</span>\
                             <span class="temp-min">{{mintempC}}°</span>\
                            </p>\
                            {{/nextDays}}\
                         </div>\
                        </div>',
                    ...
                    success: function(el, data, options){
                        ...
                        for (var i = 0; i < data.data.weather.length; i++) {
                            data.data.weather[i].dayWeatherIcon = icons["w-"+data.data.weather[i].hourly[0].weatherCode];
                            data.data.weather[i].dayWeatherPic = data.data.weather[i].hourly[0].weatherCode;
                            ...
                            data.data.weather[i].tempMin = options.typeTemp.toLowerCase() == "c"  ? 
                                                                data.data.weather[i].mintempC :
                                                                data.data.weather[i].mintempF;
                            data.data.weather[i].tempMax = options.typeTemp.toLowerCase() == "c"  ? 
                                                                data.data.weather[i].maxtempC :
                                                                data.data.weather[i].maxtempF
							console.log(data.data.weather[i].hourly[0]);
							console.log(data.data.weather[i].hourly[0].weatherCode);							
                        }
                        var weather = {
                            "day": options.day,
                            "max": options.max,
